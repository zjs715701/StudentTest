...
/**
 * @author ：Super张
 * @date ：Created in 2020/9/30 14:32
 * @description：
 * @modified By：
 * @version:
 */
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("D://生成代码//");//输出目录
        ...
        globalConfig.setAuthor("DaoChen");
        ...
        sourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/homework?serverTimezone=GMT%2B8&characterEncoding=utf-8&useSSL=false");
        ...
        packageConfig.setParent("com.student.test");// 自定义包路径
        ...
        injectionConfig.setFileOutConfigList(Collections.<FileOutConfig>singletonList(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return globalConfig.getOutputDir() + tableInfo.getEntityName() + "Mapper.xml";
            }
        }));
